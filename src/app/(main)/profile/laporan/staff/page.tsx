...
export default function AmbilLaporanStaff() {
  ...
  const handleDownload = async (params: { [key: string]: any }) => {
    try {
      let url = `http://localhost:4000/v1/staffs/download?`
      let queryParams = []
  ...
  const handleChart = async (formValues: { [key: string]: any }) => {
    try {
      let url = `http://localhost:4000/v1/staffs/chart-filtered?`
      let queryParams = []
