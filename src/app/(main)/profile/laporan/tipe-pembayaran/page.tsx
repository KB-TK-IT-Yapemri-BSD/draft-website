...
export default function AmbilLaporanTipePembayaran() {
  ...
  const handleDownload = async (params: { [key: string]: any }) => {
    try {
      let url = `http://localhost:4000/v1/paymentTypes/download?`
      let queryParams = []
  ...
  const handleChart = async (formValues: { [key: string]: any }) => {
    try {
      let url = `http://localhost:4000/v1/paymentTypes/chart-filtered?`
      let queryParams = []
          ...
          <div className="w-full">
            <div className="divide-y-2">
              <p className="font-bold text-2xl pt-4">
                Ambil Data Laporan Tipe Pembayaran
              </p>
              <form method="GET" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                  <div className="flex flex-col lg:flex-row lg:space-x-6 pb-2">
                    <div className="py-2 w-full">
                      <label
                        htmlFor="deadline"
                        className="block mb-2 text-sm font-medium read-only"
              ...
              <form method="GET" onSubmit={handleSubmit2}>
                ...
                <div className="py-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                  >
                    <option selected value="" className="text-black"></option>
