          ...
          <div className="w-full py-10 space-y-10 leading-loose">
            <div className="card">
              ...
              <p className="p-2 py-4 text-sm lg:text-lg text-center">
                Berpartisipasi dalam mencetak generasi muslim yang unggul, guna
                membentuk masyarakat yang berakhlak, berilmu pengetahuan,
                kreatif dan berprestasi, mandiri dan kompetitif
              </p>
            </div>
