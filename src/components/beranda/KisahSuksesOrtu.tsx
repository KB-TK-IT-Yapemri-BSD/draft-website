        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center py-10 px-4 lg:px-0">
          <div className="relative max-w-md mx-auto flex flex-col py-6 px-8 bg-white rounded-lg shadow-lg">
            ...
            <p className="text-[#5E6282] pt-4">
              “KB TK IT Yapemri BSD adalah sekolah yang dapat membantu tumbuh
              dan kembang anak-anak saya. Guru-gurunya pun ramah dan baik hati,
              sabar mengajarkan anak-anak. Mantap!”
            </p>
          ...
          <div className="relative max-w-md mx-auto flex flex-col py-6 px-8 bg-white rounded-lg shadow-lg">
            ...
            />
            <p className="text-[#5E6282] pt-4">
              “KB TK IT Yapemri BSD adalah sekolah yang menyenangkan dan sesuai
              untuk anak saya. Program-program nya menarik dan menyenangkan.”
            </p>
          ...
          <div className="relative max-w-md mx-auto flex flex-col py-6 px-8 bg-white rounded-lg shadow-lg">
            ...
            />
            <p className="text-[#5E6282] pt-4">
              “KB TK IT Yapemri BSD adalah sekolah yang sangat bersih,
              fasilitasnya pun lengkap. Guru-gurunya pun mudah untuk diajak
              komunikasi.”
            </p>
