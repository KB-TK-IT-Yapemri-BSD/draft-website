  ...
  const handleAddForm = async (formValues: any) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error("Form Pendaftaran gagal dikirim, silahkan coba lagi!", {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
          closeOnClick: true,
                    ...
                    <form method="POST" onSubmit={handleSubmit}>
                      ...
                      <div className="py-2 pt-4">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium read-only"
                        >
                          Phone <span className="text-red-danger">*</span>
                        </label>
                        <input
                          type="text"
                          id="phone"
                      ...
                      <div className="py-2 pt-4">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium read-only"
                        >
                          Address <span className="text-red-danger">*</span>
                        </label>
                        <input
                          type="text"
                          id="address"
                      ...
                      <div className="py-2 pt-4">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium read-only"
                        >
                          Kelompok Usia yang Akan Disekolahkan (KB/ TK A/ TK B){" "}
                          {""}
                          <span className="text-red-danger">*</span>
                        </label>
                        <input
                      ...
                      <div className="py-2 pt-4">
                        <label
                          ...
                          className="block mb-2 text-sm font-medium read-only"
                        >
                          Alasan Mendaftar di KB TK IT Yapemri BSD{" "}
                          <span className="text-red-danger">*</span>
                        </label>
                        <input
                          type="text"
                        ...
                        {errors.reason && (
                          <span className="text-red-danger text-sm">
                            {errors.reason ? "* " + errors.numChildrens : ""}
                            <br />
                          </span>
                        )}
                      </div>
