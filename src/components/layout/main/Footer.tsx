    ...
    <div className="bg-secondary text-white divide-y-[1px]">
      <div className="py-20 flex flex-col mx-10 divide-y-[1px] lg:divide-y-0 lg:mx-40 lg:flex-row lg:space-x-10">
        ...
        <div className="my-8 lg:my-0 lg:w-3/12 lg:px-10">
          <h1 className="text-xl my-6 lg:mb-6 font-bold">Media Sosial</h1>
        ...
        <div className="lg:w-1/3 lg:px-10">
          <h1 className="text-xl my-6 lg:mb-6 font-bold">Hubungi Kami</h1>
          <div className="space-y-1 leading-relaxed -mb-10 lg:mb-0">
            <p className="text-lg font-semibold">Alamat</p>
            <p className="text-sm">
              Komplek DELATINOS, Ruko Bravo Centro Havana, Blok MA 20 & MA 23,
              Rawa Buntu, BSD City, Tangerang Selatan
            </p>

            <p className="text-lg font-semibold">Jam Buka</p>
            <p className="text-sm">Hari Kerja, Senin-Jumat (08:00-14:00)</p>
      ...
      <div className="py-10 mx-10 lg:mx-40">
        <p>Copyright © 2023 KB TK IT Yapemri BSD. All Rights Reserved.</p>
      </div>
    </div>
  )
}
