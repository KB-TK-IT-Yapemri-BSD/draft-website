        ...
        <table className="my-4 w-full">
          <thead>
            <tr>
              ...
              <th className="border border-black px-4 py-2">RINCIAN</th>
              <th className="border border-black px-4 py-2">JUMLAH</th>
            </tr>
          </thead>
          <tbody>
            <tr>
            ...
            <tr>
              ...
              <td className="border border-black px-4 py-2">Uang Pangkal</td>
              <td className="border border-black px-4 py-2">Rp. 7.500.000</td>
            </tr>
            <tr>
              ...
              <td className="border border-black px-4 py-2">Rp. 2.500.000</td>
            </tr>
            <tr>
              ...
              <td className="border border-black px-4 py-2">Rp. 1.250.000</td>
            </tr>
            <tr>
              <td className="border border-black px-4 py-2">5</td>
              <td className="border border-black px-4 py-2">SPP Bulan</td>
              <td className="border border-black px-4 py-2">Rp. 1.000.000</td>
            </tr>
            <tr>
              <td
                colSpan={2}
