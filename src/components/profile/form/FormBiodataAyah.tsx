...
export default function FormBiodataAyah(props: any) {
  ...
  useEffect(() => {
    if (isMount) {
      // console.log('First Render AYAH');
    } else {
      // console.log('Subsequent Render AYAH');

      if (!props) {
        // console.log('No props');
      } else if (props) {
        setData(props.props.father_id)
      }
    }
  })
  ...
  return (
    <div className="divide-y-2">
      <p className="text-2xl py-4">Biodata Ayah</p>
      ...
      <div className="space-y-2">
        ...
        <div className="py-2">
          ...
          <input
            ...
            id="gender"
            className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            value={data ? (data["gender"] ? "Wanita" : "Pria") : "NO DATA"}
            disabled
          />
        </div>
