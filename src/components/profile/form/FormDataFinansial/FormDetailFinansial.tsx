      ...
      <div className="space-y-2">
        ...
        <div className="py-2">
          ...
          <input
            ...
            aria-label="type_id"
            className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-black"
            value={dataPayment ? dataPayment["type_id"]["type"] : "NO DATA"}
            disabled
          />
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-6">
          <div className="py-2 w-full">
            ...
            <input
              ...
              aria-label="amount"
              className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-black"
              placeholder={dataPayment ? dataPayment["amount"] : "NO DATA"}
              disabled
            />
          </div>
          <div className="py-2 w-full">
        ...
        <div className="py-2">
          ...
          {dataPayment ? (
            dataPayment["receipt"] ? (
              <>
                {" "}
                <h1 className="my-2 text-sm">Preview Bukti Pembayaran: </h1>
                <div className="relative text-center w-1/2 h-1/4">
                  ...
                  >
                    <img
                      src={dataPayment["receipt"] ? dataPayment["receipt"] : ""}
                      alt="Image Preview"
                    />
                    {isHovered && (
