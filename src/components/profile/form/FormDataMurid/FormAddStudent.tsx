    ...
    <form method="POST" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-6">
        ...
        <div className="py-2 w-full">
          <label
            ...
            className="block mb-2 text-sm font-medium read-only"
          >
            Nama Panggilan <span className="text-red-danger">*</span>
          </label>
          <input
            type="text"
            id="nickname"
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-6">
        ...
        <div className="py-2 w-full">
          <label
            ...
            className="block mb-2 text-sm font-medium read-only"
          >
            Jumlah Saudara <span className="text-red-danger">*</span>
          </label>
          <input
            type="number"
            id="numOfSiblings"
          ...
          {errors.numOfSiblings && (
            <span className="text-red-danger text-sm">
              {errors.numOfSiblings ? "* " + errors.numOfSiblings : ""}
              <br />
            </span>
          )}
        </div>
      ...
      <div className="py-2 pt-3">
        <label
          ...
          className="block mb-2 text-sm font-medium read-only"
        >
          Status di Keluarga <span className="text-red-danger">*</span>
        </label>
        <input
          type="text"
          id="statusInFamily"
        ...
        {errors.statusInFamily && (
          <span className="text-red-danger text-sm">
            {errors.statusInFamily ? "* " + errors.statusInFamily : ""}
            <br />
          </span>
        )}
      </div>
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-6">
        ...
        <div className="py-2 w-full">
          <label
            ...
            className="block mb-2 text-sm font-medium read-only"
          >
            Golongan Darah <span className="text-red-danger">*</span>
          </label>
          <select
            id="bloodType"
            className="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
      ...
      <div className="py-2 pt-3">
        ...
        {errors.diseaseHistory && (
          <span className="text-red-danger text-sm">
            {errors.diseaseHistory ? "* " + errors.diseaseHistory : ""}
            <br />
          </span>
        )}
      </div>
      ...
      <div className="py-2">
        <label
          ...
          className="block mb-2 text-sm font-medium read-only"
        >
          Jarak Tempat Tinggal ke TK <span className="text-red-danger">*</span>
        </label>
        <input
          type="text"
          id="distanceToHome"
        ...
        {errors.distanceToHome && (
          <span className="text-red-danger text-sm">
            {errors.distanceToHome ? "* " + errors.distanceToHome : ""}
            <br />
          </span>
        )}
      </div>
      ...
      <div className="py-2">
        <label
          ...
          className="block mb-2 text-sm font-medium read-only"
        >
          Bahasa Sehari-hari <span className="text-red-danger">*</span>
        </label>
        <input
          type="text"
          id="language"
