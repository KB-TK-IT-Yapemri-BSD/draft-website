      ...
      <div className="space-y-2">
            ...
            value={
              dataUser
                ? dataUser["birthplace"] +
                  ...
                  "/" +
                  (new Date(dataUser["birthdate"]).getMonth() + 1) +
                  "/" +
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-6">
          ...
          <div className="py-2 w-full">
            ...
            <input
              ...
              className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
              value={dataUser ? dataUser["citizenship"] : "NO DATA"}
              disabled
            />
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-6">
          <div className="py-2 w-full">
            ...
            <input
              ...
              className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
              value={dataUser ? dataUser["birthOrder"] : "NO DATA"}
              disabled
            />
          </div>
          ...
          <div className="py-2 w-full">
            ...
            <input
              ...
              className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
              value={dataUser ? dataUser["numOfSiblings"] : "NO DATA"}
              disabled
            />
          </div>
        </div>
        ...
        <div className="py-2">
          ...
          <input
            ...
            className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            value={dataUser ? dataUser["statusInFamily"] : "NO DATA"}
            disabled
          />
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-6">
          <div className="py-2 w-full">
            ...
            <input
              ...
              aria-label="height"
              className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
              value={dataUser ? dataUser["height"] + " cm" : "NO DATA"}
              disabled
            />
          </div>
          <div className="py-2 w-full">
            ...
            <input
              ...
              aria-label="weight"
              className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
              value={dataUser ? dataUser["weight"] + " kg" : "NO DATA"}
              disabled
            />
          </div>
        </div>
        ...
        <div className="py-2">
          ...
          <input
            ...
            className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            value={dataUser ? dataUser["diseaseHistory"] : "NO DATA"}
            disabled
          />
        </div>
        ...
        <div className="py-2">
          ...
          <input
            ...
            className="bg-gray-100 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            value={dataUser ? dataUser["distanceToHome"] : "NO DATA"}
            disabled
          />
        </div>
