...
export default function FormUpdateParent({ params }: { params: any }) {
  ...
  const handleUpdateParents = async (formValues: any) => {
    ...
    try {
      ...
      const results = await fetch(`http://localhost:4000/v1/parents/${id}`, {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${session?.user.token.accessToken}`,
      ...
      if (results?.status === 401) {
        toast.error("Data Orang Tua gagal diubah, silahkan coba lagi!", {
          position: "top-center",
          autoClose: 5000,
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-6">
        ...
        <div className="py-2 w-full">
          ...
          <select
            ...
            onChange={handleChange}
          >
            <option defaultValue={formValues.gender} selected disabled hidden>
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-6 space-y-2 lg:space-y-0">
        <div className="py-2 lg:w-1/2">
          ...
          <select
            ...
            onChange={handleChange}
          >
            <option defaultValue={formValues.religion} selected disabled hidden>
              {formValues.religion}
            </option>
