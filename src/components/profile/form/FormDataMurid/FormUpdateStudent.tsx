...
export default function FormUpdateStudent({ params }: { params: any }) {
  ...
  const handleUpdateStudents = async (formValues: any) => {
    ...
    try {
      ...
      const results = await fetch(`http://localhost:4000/v1/students/${id}`, {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${session?.user.token.accessToken}`,
    ...
    <form method="PATCH" onSubmit={handleSubmit}>
      ...
      <div className="py-2">
        ...
        <select
          ...
          onChange={handleChange}
        >
          <option value={formValues.studentStatus} selected disabled hidden>
        ...
        {errors.studentStatus && (
          <span className="text-red-danger text-sm">
            {errors.studentStatus ? "* " + errors.studentStatus : ""}
            <br />
          </span>
        )}
      </div>
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-6">
        ...
        <div className="py-2 w-full">
          ...
          <select
            ...
            onChange={handleChange}
          >
            <option value={formValues.bloodType} selected disabled hidden>
