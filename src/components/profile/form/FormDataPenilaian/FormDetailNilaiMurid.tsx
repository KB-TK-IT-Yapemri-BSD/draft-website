...
export default function FormDetailNilaiMurid({ params }: { params: any }) {
  ...
  const getDataPenilaian = async () => {
    try {
      let res = await fetch(`http://localhost:4000/v1/evaluations/${id}`, {
        method: "GET",
        headers: {
        ...
        <table className="table-auto w-full border border-black p-4">
          <tbody>
            ...
            <tr>
              ...
              <td className="border border-black p-2 w-1/4">KB</td>
              <td className="font-medium read-only border border-black p-2 bg-grey w-1/4">
                Periode
              </td>
              <td className="border border-black p-2 w-1/4">Semester II</td>
            </tr>
          </tbody>
        </table>
            ...
            <tr>
              <td className="border border-black p-2" colSpan={4}>
                <p className="text-justify">
                  {dataPenilaian ? dataPenilaian["introduction"] : "NO DATA"}
                </p>
              </td>
            </tr>
          </tbody>
        ...
        <table className="table-auto w-full border border-black p-4">
          <tbody>
            ...
            <tr>
              <td className="border border-black p-2" colSpan={4}>
                <p className="text-justify">
                  {dataPenilaian ? dataPenilaian["aspect_1"] : "NO DATA"}
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-black p-2">
                {dataPenilaian ? dataPenilaian["score_aspect_1"] : "NO DATA"}
              </td>
            </tr>
            <tr>
              <td
            ...
            <tr>
              <td className="border border-black p-2" colSpan={4}>
                <p className="text-justify">
                  {dataPenilaian ? dataPenilaian["aspect_2"] : "NO DATA"}
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-black p-2">
                {dataPenilaian ? dataPenilaian["score_aspect_2"] : "NO DATA"}
              </td>
            </tr>
            <tr>
              <td
            ...
            <tr>
              <td className="border border-black p-2" colSpan={4}>
                <p className="text-justify">
                  {dataPenilaian ? dataPenilaian["aspect_3"] : "NO DATA"}
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-black p-2">
                {dataPenilaian ? dataPenilaian["score_aspect_3"] : "NO DATA"}
              </td>
            </tr>
            <tr>
              <td
            ...
            <tr>
              <td className="border border-black p-2" colSpan={4}>
                <p className="text-justify">
                  {dataPenilaian ? dataPenilaian["aspect_4"] : "NO DATA"}
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-black p-2">
                {dataPenilaian ? dataPenilaian["score_aspect_4"] : "NO DATA"}
              </td>
            </tr>
            <tr>
              <td
            ...
            <tr>
              <td className="border border-black p-2" colSpan={4}>
                <p className="text-justify">
                  {dataPenilaian ? dataPenilaian["aspect_5"] : "NO DATA"}
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-black p-2">
                {dataPenilaian ? dataPenilaian["score_aspect_5"] : "NO DATA"}
              </td>
            </tr>
            <tr>
              <td
            ...
            <tr>
              <td className="border border-black p-2" colSpan={4}>
                <p className="text-justify">
                  {dataPenilaian ? dataPenilaian["aspect_6"] : "NO DATA"}
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td className="border border-black p-2">
                {dataPenilaian ? dataPenilaian["score_aspect_6"] : "NO DATA"}
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="table-auto w-full border border-black p-4">
          <tbody>
            ...
            <tr>
              <td className="border border-black p-2" colSpan={4}>
                <p className="text-justify">
                  {dataPenilaian ? dataPenilaian["closing"] : "NO DATA"}
                </p>
              </td>
            </tr>
          </tbody>
