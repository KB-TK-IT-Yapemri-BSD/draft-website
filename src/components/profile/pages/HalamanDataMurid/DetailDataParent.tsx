...
import FormDetailParent from '../../form/FormDataMurid/FormDetailParent';

export default function DetailDataParent({ params }: { params: any }) {
	return (
				...
				<div className="card outline outline-grey outline-[1px] p-8">
					<div className="w-full divide-y-2">
						<p className="font-bold text-2xl pt-4">
							Detail Data Orang Tua Murid
						</p>
						<div className="my-6">
							<FormDetailParent params={params} />
						</div>
					</div>
				</div>
			</div>
