...
import FormUpdateStudent from "../../form/FormDataMurid/FormUpdateStudent"

export default function HalamanUpdateStudent({ params }: { params: any }) {
  return (
      ...
      <div className="mx-10 py-20 lg:mx-60 space-y-6">
        ...
        <div className="card outline outline-grey outline-[1px] p-8">
          <div className="w-full divide-y-2">
            <p className="font-bold text-2xl pt-4">Ubah Data Murid</p>
            <div className="my-6">
              <FormUpdateStudent params={params} />
            </div>
          </div>
        </div>
      </div>
