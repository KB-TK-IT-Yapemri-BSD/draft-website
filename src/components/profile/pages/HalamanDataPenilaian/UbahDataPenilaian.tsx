...
import FormUpdatePenilaian from '../../form/FormDataPenilaian/FormUpdateDataPenilaian';

export default function HalamanUpdatePenilaian({ params }: { params: any }) {
	return (
			...
			<div className="mx-10 py-20 lg:mx-60 space-y-6">
				...
				<div className="card outline outline-grey outline-[1px] p-8">
					<div className="w-full divide-y-2">
						...
						<div className="my-6">
							<FormUpdatePenilaian params={params} />
						</div>
					</div>
				</div>
			</div>
