              ...
              ? dataEvaluations.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      {item["grade"] ? item["grade"] : "NO DATA"}
                    </td>
                    <td className="px-6 py-4">
                      {item["period"] ? item["period"] : "NO DATA"}
                    </td>
                    <td className="px-6 py-4">
                      {item["createdAt"]
                    ...
                    <td className="flex items-center px-6 py-4 space-x-2">
                      <button
                        ...
                        onClick={() =>
                          router.push(`/profile/penilaian/${item["id"]}`)
                        }
                      >
                        <EyeSymbol />
                      </button>
                      <button
                        ...
                        onClick={() =>
                          router.push(`/profile/penilaian/update/${item["id"]}`)
                        }
                      >
                        <PencilSymbol />
                      </button>
                                    ...
                                    <Dialog.Panel className="w-full max-w-sm transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle transition-all">
                                      ...
                                      <div className="flex gap-4 justify-center">
                                        <button
                                          ...
                                          onClick={() => {
                                            handleDeleteEvaluation(currentId)
                                          }}
                                        >
